...
extern "C" void vshmain_45D85C54(uint32_t flag);   // set running mode flag _ZN3vsh18SetCooperationModeENS_15CooperationModeE	vsh::SetCooperationMode(vsh::CooperationMode)
...
extern "C" void vshmain_5046CFAB();  // _ZN3vsh20ApplyCooperationModeEv	vsh::ApplyCooperationMode(void)
...
extern "C" int (*vshmain_74A54CBF)(int r3);
extern "C" int (*vshmain_5F5729FB)(int r3);
...
extern "C" int32_t vshmain_AE35CF2D(char *, int value);  // call_xmb_plugin | Executes Action based on Input (XMB Plugin XMM0 Interface 23), Examples: "https://www.psdevwiki.com/ps3/Xmb_plugin",0; "copy:device",1; "regcam:reg?",1
